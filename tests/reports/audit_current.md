...
- 🟠 **HIGH** (行 108): 函数 'execute_full_workflow' 过长 (121 行)
  💡 考虑将函数拆分为更小的子函数
- 🟠 **HIGH** (行 432): 函数 '_execute_phase_with_iteration' 过长 (138 行)
  💡 考虑将函数拆分为更小的子函数
- 🟠 **HIGH** (行 791): 函数 '_generate_final_report' 过长 (157 行)
  💡 考虑将函数拆分为更小的子函数
- 🟠 **HIGH** (行 949): 函数 '_generate_markdown_report' 过长 (135 行)
  💡 考虑将函数拆分为更小的子函数
- 🟡 **MEDIUM** (行 263): 函数 '_interactive_plan_confirmation' 较长 (62 行)
  💡 考虑是否可以简化逻辑
- 🟡 **MEDIUM** (行 349): 函数 '_plan_constraint_audit' 较长 (82 行)
  💡 考虑是否可以简化逻辑
...
- 🟠 **HIGH** (行 55): 使用裸 except 语句
  💡 指定具体的异常类型
- 🟠 **HIGH** (行 93): 使用裸 except 语句
  💡 指定具体的异常类型
- 🟠 **HIGH** (行 98): 使用裸 except 语句
  💡 指定具体的异常类型
- 🟠 **HIGH** (行 135): 使用裸 except 语句
  💡 指定具体的异常类型
- 🟠 **HIGH** (行 140): 使用裸 except 语句
  💡 指定具体的异常类型
...
| agents\workflow_orchestrator_v3_final.py | 1107 | 286 | 667 | ⚠️ 72.6% | 6.5 |
