...
- 🟠 **HIGH** (行 895): 函数 '_generate_final_report' 过长 (157 行)
  💡 考虑将函数拆分为更小的子函数
- 🟠 **HIGH** (行 1053): 函数 '_generate_markdown_report' 过长 (135 行)
  💡 考虑将函数拆分为更小的子函数
- 🟡 **MEDIUM** (行 287): 函数 '_interactive_plan_confirmation' 较长 (62 行)
  💡 考虑是否可以简化逻辑
- 🟡 **MEDIUM** (行 373): 函数 '_plan_constraint_audit' 较长 (82 行)
  💡 考虑是否可以简化逻辑
- 🟡 **MEDIUM** (行 456): 函数 '_execute_phase_with_iteration' 较长 (58 行)
  💡 考虑是否可以简化逻辑
- 🟡 **MEDIUM** (行 586): 函数 '_handle_first_iteration_interaction' 参数过多 (8 个)
  💡 考虑使用参数对象或配置字典
...
- 🟢 **LOW** (行 0): 重复的导入: time
- 🟢 **LOW** (行 0): 重复的导入: os
- 🟡 **MEDIUM** (行 420): 函数 '_execute_local' 较长 (80 行)
  💡 考虑是否可以简化逻辑
...
| agents\workflow_orchestrator_v3_final.py | 1211 | 265 | 778 | ⚠️ 77.3% | 3.8 |
...
| lib\agent_executor.py | 566 | 255 | 224 | ⚠️ 68.0% | 1.9 |
